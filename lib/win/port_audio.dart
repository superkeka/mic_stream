...
class PortAudio {
  ...
  static String? _dependencyDir;

  // Port Audio Helper Library
  static int Function(Pointer<Void>)? _PahInit;
  static int Function()? _PaGetVersion;
  static Pointer<Utf8> Function()? _PaGetVersionText;
  static Pointer<VersionInfo> Function()? _PaGetVersionInfo;
  static Pointer<Utf8> Function(int)? _PaGetErrorText;
  static int Function()? _PaInitialize;
  ...
  static Pointer<HostErrorInfo> Function()? _PaGetLastHostErrorInfo;
  static int Function()? _PaGetDeviceCount;
  static int Function()? _PaGetDefaultInputDevice;
  static int Function()? _PaGetDefaultOutputDevice;
  ...
  static  void _load() {
    ...
    if (Platform.isWindows) {
      if(_dependencyDir != null){
        paPath = _dependencyDir!+'portaudio_' + bits + '.dll';
      }
      else {
    ...
    _PaGetVersion = paLib
        .lookup<NativeFunction<Int32 Function()>>('Pa_GetVersion')
        .asFunction();
    ...
    _PaGetDefaultHostApi = paLib
        .lookup<NativeFunction<Int32 Function()>>('Pa_GetDefaultHostApi')
        .asFunction();
    ...
    _PaGetLastHostErrorInfo = paLib
        .lookup<NativeFunction<Pointer<HostErrorInfo> Function()>>(
        'Pa_GetLastHostErrorInfo')
        .asFunction();

    _PaGetDeviceCount = paLib
        .lookup<NativeFunction<Int32 Function()>>('Pa_GetDeviceCount')
        .asFunction();
    ...
    if (Platform.isWindows) {
      if(_dependencyDir != null){
        pahPath = _dependencyDir!+'port_audio_helper_' + bits + '.dll';
      }
      else{
  ...
  static int init(){
    ...
    return _PahInit!(NativeApi.initializeApiDLData);
  }
  ///
  ...
  /// See Terminate
  ///
  static int initialize(String? dependencyDir) {
  ...
  static HostErrorInfo getLastHostErrorInfo() {
    ...
    return _PaGetLastHostErrorInfo!().ref;
  }
  ...
  static int getDefaultInputDevice() {
    ...
    return _PaGetDefaultInputDevice!();
  }
  ...
  static int getDefaultOutputDevice() {
    ...
    return _PaGetDefaultOutputDevice!();
  }
